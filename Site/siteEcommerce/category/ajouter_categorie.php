...
if(is_post2()){
    ...
    $query = pdo()->prepare('INSERT INTO categories (name, image_categorie) VALUES (?, ?)');
    $query->execute([$_POST['name'], $dst_db] );

    echo 'insertion est faite';
...
<form method="post"  enctype= "multipart/form-data" >
 ...
 <p class="mb-4 font-semibold ">
     ...
     <input type="file" name="image_categorie" value="uplaod" Required>
 </p>

     <button  class="font-semibold w-full border-2 py-1 bg-gray-200"  >Ajouter</button>
 </p>
